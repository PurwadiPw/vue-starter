...
import HeaderToolbar from "@components/layouts/header-toolbar.vue";
import SideNavMenu from "@components/layouts/side-nav-menu.vue";
...
export default {
  ...
  mounted() {
    this.initPerfectScrollbar('.router-tab__container')
  },
  computed: {
    drawerOptions() {
      ...
      return {
        ...
        minMenuSize: this.isXSmall ? 0 : 45,
        menuOpened: this.isLarge,
